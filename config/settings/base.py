...
ROOT_DIR = environ.Path(__file__) - 3  # (sdu_beta_career/config/settings/base.py - 3 = sdu_beta_career/)
APPS_DIR = ROOT_DIR.path('sdu_beta_career')
...
MIGRATION_MODULES = {
    'sites': 'sdu_beta_career.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Anuar Akhmetov""", 'sdu.beta.career@gmail.com'),
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'sdu_beta_career.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'sdu_beta_career.users.adapters.SocialAccountAdapter'
